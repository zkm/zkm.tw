...
vi.mock('lucide-react', () => ({
  ...
  GraduationCap: () =>
    React.createElement('div', { 'data-testid': 'graduation-icon' }, 'GraduationCap'),
  HeartHandshake: () =>
    React.createElement('div', { 'data-testid': 'heart-icon' }, 'HeartHandshake'),
  ...
  MessageCircle: () =>
    React.createElement('div', { 'data-testid': 'message-circle-icon' }, 'MessageCircle'),
